const { RegisterHotel, GetAllHotel, GetSingleHotel, UpdateHotelData, DeleteAllHotel, DeleteSingleHotel, DeleteAllHotelData, FilterTheHotelData, ReqHotelData, GetUsersHotel, fitlerDataCreate, GetSearchTheHotelList, GetFieldList, pagination, DeleteSelectedVendorHotel, DeleteSigleHotel } = require('../../Controllers/HotelControllers/hotelControllers');
const { UpdateRoomData, AddRoomType, GetAllRoomOfSingleHotel, DeleteRoomDataFromHotel } = require('../../Controllers/HotelControllers/roomManagementControllers');
